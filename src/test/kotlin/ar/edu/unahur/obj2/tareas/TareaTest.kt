...
class TareaTest : DescribeSpec({
  describe("Una tarea") {
    val empleado20p = Empleados(20.0)
    val empleado30p = Empleados(30.0)
    val empleado40p = Empleados(40.0)
    val empleado50p = Empleados(50.0)
    val empleado60p = Empleados(60.0)
